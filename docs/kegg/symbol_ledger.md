...
| 0x11b541 | `set_draw_params(p0,p1,flag,p3,p4)` — store the packed draw-param block {dword,dword,byte,dword,dword} at [0x14e200] the 0x11bxxx draw routines read | VERIFIED | `kegg/recovered/present.py`; oracle-exact over demo_6660265 |
| 0x117e62 | `spawn_effect(a0..a5,flags)` — append a 32-byte effect record to the 50-slot array at [0x1494b8] (count [0x14dd84]); packs flag bits into rec[+0x1c/+0x1d] | VERIFIED | `kegg/recovered/effects.py`; 62/62 oracle-exact over demo_6660265 |
| 0x119e54 | `update_frame_timers` — 2nd per-frame timer table (12-byte recs at 0x14e168): accumulate step [0x1473ac], wrap at threshold, bump counter; gated global tick [0x14e1be] | VERIFIED | `kegg/recovered/anim.py`; 600/600 oracle-exact over demo_6660265 |
